...
protected:
    void run();
    void copyDouble2Bit(double t, uint8_t *bits) { memcpy(bits, &t, sizeof(double)); }
    void copyBit2Double(uint8_t *bits, double &t) { memcpy(&t, bits, sizeof(double)); }
    void copyInt2Bit(int t, uint8_t *bits) { memcpy(bits, &t, sizeof(int)); }
    void copyBit2Int(uint8_t *bits, int &t) { memcpy(&t, bits, sizeof(int)); }
    void copyFloat2Bit(float t, uint8_t *bits) { memcpy(bits, &t, sizeof(int)); }
    void copyBit2Float(uint8_t *bits, float &t) { memcpy(&t, bits, sizeof(int)); }
